...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/20 09:50:58 by chukim            #+#    #+#             */
/*   Updated: 2022/10/20 09:50:58 by chukim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const unsigned int	ScavTrap::_class_attack_energy_cost = 1;
...
void ScavTrap::attack(std::string const & target)
{
	...
	{
		std::cout << class_name << " " << name << " beat " << target << " and inflict " << dmg << " damage points!\n";;
