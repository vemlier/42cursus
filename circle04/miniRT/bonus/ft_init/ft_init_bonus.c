...
/*   Updated: 2022/12/21 22:09:36 by chukim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_init_classify2(char **arr, t_scene *scene)
{
	...
	else if (ft_strncmp(arr[0], CONE, ft_strlen(arr[0])) == 0)
		return (ft_init_cone(&arr[1], scene));
	return (1);
}
...
int	ft_init_classify(char **arr, t_scene *scene)
{
	...
	else if (ft_strncmp(arr[0], LIGHT2, ft_strlen(arr[0])) == 0)
	{
